...
public class CameraCtrl : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        a_LmtBdLeft = m_GroundMin.x + 8.0f + m_ScWdHalf.x;
        a_LmtBdTop = m_GroundMax.y + 4.0f + m_ScWdHalf.y;
        a_LmtBdRight = m_GroundMax.x - 8.0f - m_ScWdHalf.x;
        a_LmtBdBottom = m_GroundMax.y - 4.0f - m_ScWdHalf.z;
